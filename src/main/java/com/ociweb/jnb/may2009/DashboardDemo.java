package com.ociweb.jnb.may2009;
...
public class DashboardDemo extends JFrame {
    ...
    /**
     * Build the main panel of the dashboard using the MiGLayout layout manager.
     */
    ...
    /**
     * Build the main panel of the dashboard using the standard layout managers
    ...
    /**
     * Everything below here is just setup code that is the same for all
     * examples. It is not part of the comparison.
     */
    private void initializeDockingComponents() {
        ...
        ImageIcon avatarIcon
                = new ImageIcon(getClass().getClassLoader().getResource("com/ociweb/jnb/apr2009/avatar.gif"));
